...
using AtlantaCodeCampMobile.Models.AboutUs;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace AtlantaCodeCampMobile.ViewModels.AboutUs
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:AtlantaCodeCampMobile.ViewModels.AboutUs.AboutUsViewModel"/> class.
        /// </summary>
